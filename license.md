...
1. **Usage Restriction**: The Software (DataPredict-Agent) may **only be used** in conjunction with other software libraries authored by Aqwam Harish Aiman. No software libraries that is not authored by Aqwam Harish Aiman is allowed to be used with the Software.
