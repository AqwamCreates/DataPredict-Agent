...
1. **Usage Restriction**: The Software (DataPredict-Agent) **must be used** in conjunction with other software libraries authored by Aqwam Harish Aiman.
...
4. **Modification**: **Any modifications or derivative works of the Software** must remain compliant with this license and must integrate with software libraries created by Aqwam Harish Aiman.
