...
1. **Usage Restriction**: The Software (DataPredict-Agent) may **only be used** in conjunction with other software libraries authored by Aqwam Harish Aiman. Software libraries not authored by Aqwam Harish Aiman are prohibitted to be used with the Software.
